...
from csdp_training.utility import acc, f1, kappa, log_test_step


class LSeqSleepNet_Lightning(Base_Lightning):
    def __init__(self, lseqsleep, lr, batch_size, lr_patience, lr_factor, lr_minimum):

        super().__init__(lseqsleep, lr, batch_size, lr_patience, lr_factor, lr_minimum)
    ...
    def test_step(self, batch, _):
        ...
        log_test_step(
            ...
            tags[1],
            tags[2],
            channel_pred=y_pred_ensemble,
            single_pred=y_pred_single,
            labels=y_temp,
        )
